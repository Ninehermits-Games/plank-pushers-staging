...
var ASM_CONSTS = {
  4191632: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 4191687: function($0) {performance.now = function() { return $0; };},  
 4191735: function($0) {performance.now = function() { return $0; };},  
 4191783: function() {performance.now = Module['emscripten_get_now_backup'];},  
 4191838: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 4191899: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 4191963: function() {return Module.webglContextAttributes.powerPreference;}
};
          ...
          try {
            ...
            if (
              ...
              window.Telegram.WebApp.showAlert(
                "Your FLEX pass has already been activated!",
                () =>
  ...
  function _DownloadScreenshot(array, size, fileNamePtr) {
  ...
  function _EnableEruda() {
      try {
        eruda.init();
      } catch (erudaEnableErr) {
        console.log({ erudaEnableErr });
      }
    }
      ...
      if (
        ...
        (async () => {
          ...
          try {
            const eventData = [
              {
                slug: "4073-open-link-1724623073507", // Replace with the actual slug
            ...
            await response.json();
            window.unityInstance.SendMessage("RequestHandler", "NotTaskBackend");
          } catch (err) {
            console.log(err);
          }
        })();
  ...
  function _OpenExternalLink(url) {
      if (window.Telegram.WebApp && window.unityInstance) {
        window.Telegram.WebApp.openExternalLink(UTF8ToString(url));
      }
    }
  ...
  function _OpenTelegramLink() {
      if (window.Telegram && window.Telegram.WebApp) {
        // const l = UTF8ToString(url);
        window.Telegram.WebApp.openTelegramLink("https://t.me/Plank_Pushers");
      }
    }
  ...
  function _RequestThemeParams() {
      if (window.unityInstance) {
        window.unityInstance.SendMessage(
          "TelegramController",
          "SetThemeParams",
          JSON.stringify(window.Telegram.WebApp.themeParams)
        );
      }
    }
  ...
  function _SaveWalletData(url, token) {
  ...
  function _Screenshot(base64String) {
      ...
      try {
        ...
        const file = new File([blob], "Plank_Pushers.png", { type: "image/png" });
  ...
  function _ShareInviteLink(link) {
      ...
      // console.log("Link received", l);
      (async (l) => {
        let shared = false;
        const shareData = {
          text: `Want to join the fun and access the $PUSH Airdrop?\nConnect with me and start playing:${l}.\nLet's build the best gaming community on TON together`,
          title: "Join Me in Plank Pushers!",
        };
        ...
        try {
          if (navigator) {
            await navigator.clipboard.writeText(
              `Want to join the fun and access the $PUSH Airdrop?\nConnect with me and start playing:${l}.\nLet's build the best gaming community on TON together`
            );
            if (!shared) {
              window.Telegram.WebApp.showAlert(
          ...
          window.Telegram.WebApp.showAlert(
            "Sharing not supported on this browser or device"
          );
  ...
  function _WalletInitalize(returnUrl, manifest) {
      if (
        ...
        try {
          ...
          // window.tonConnectUI.openModal().then(() => {
          //   window.fitScreen();
          // });
          window.addEventListener(
            "ton-connect-ui-transaction-signed",
            (event) => {
              console.log("Transaction transaction-signed", event.detail);
              window.unityInstance.SendMessage(
                "RequestHandler",
                "PremiumCheckerFunction"
              );
            }
          );
        } catch (err) {
...
var asmLibraryArg = {
  "BuyPremiumPass": _BuyPremiumPass,
  "CheckPremium": _CheckPremium,
  "Close": _Close,
  "DownloadScreenshot": _DownloadScreenshot,
  "EnableEruda": _EnableEruda,
  "Expand": _Expand,
  ...
  "SaveWalletData": _SaveWalletData,
  "Screenshot": _Screenshot,
  "SendDataToBackend": _SendDataToBackend,
  "SendScore": _SendScore,
  "SendTransaction": _SendTransaction,
  "ShareInviteLink": _ShareInviteLink,
  ...
  "WalletDisconnect": _WalletDisconnect,
  "WalletInfo": _WalletInfo,
  "WalletInitalize": _WalletInitalize,
